  ...
  return (
    <>
            ...
            <div className="cards-header container">
                ...
                <p>At <span>Redding Rehab Treatment Center</span>, clients receive individual therapy alongside a range of additional treatments, including relapse prevention, trauma therapy, mindfulness meditation, transportation, yoga, and more. We offer support that clients need to allow them to gradually go back to treatment. </p>
            </div>
<div class="card-wrap">
<div class="tile"> 
  <Fade left>
