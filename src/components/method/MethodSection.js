  ...
  return (
    <>
      ...
      <div className="container treatment-section-overview">
        ...
        <p>
          Here at Redding Rehab, we firmly stand that without addressing our
          ...
          <br />
          <br />
          Methods used by Redding Rehab are non-invasive, distinct, and
      ...
      <div className="treatment-section-activities">
        <div className="treatment-left">
          ...
          <p>
            Redding Rehab promotes fun activities that clients learn how to
