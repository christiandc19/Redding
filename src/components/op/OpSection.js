...
<div className='wrap'>
    ...
    <div className="box box-left">
        ...
        <p>
        At Redding Rehab Treatment Center, we provide several other avenues of addiction treatment. In addition to our partial hospitalization program, we offer:</p>
        <br />
        <ul>
